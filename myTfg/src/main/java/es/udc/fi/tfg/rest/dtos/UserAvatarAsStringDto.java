 ...
 * The Class UserDto.
 */
public class UserAvatarAsStringDto {
     ...
     * @param role the role
     */
    public UserAvatarAsStringDto(Long id, String userName, String firstName, String lastName, String email, String role, String avatar) {
