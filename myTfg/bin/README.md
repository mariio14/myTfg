...
Now you can test your app in http://localhost:3000/mytfg
...
* Start the application
    ...
    mvn spring-boot:run
    ```
Thanks to the provided plugin configuration you can access your React app directly on http://localhost:8080/mytfg
